...
static bool
CreateNewGlobal(JSContext *cx, JSClass *clasp, JSZoneId zone, nsIPrincipal *principal,
                ...
                JSCompartment **compartment)
{
    ...
    JSObject *tempGlobal =
        JS_NewGlobalObject(cx, clasp, nsJSPrincipals::get(principal), zone);
                       ...
                       JSCompartment **compartment)
{
    ...
    if (!CreateNewGlobal(cx, clasp, zone, principal, priv, global, compartment))
        return UnexpectedFailure(NS_ERROR_FAILURE);
