                              ...
                              nsIDOMDataTransfer* aDataTransfer)
{
  ...
  ErrorResult rv;
  InitDragEvent(aType, aCanBubble, aCancelable, aView, aDetail, aScreenX,
                aScreenY, aClientX, aClientY, aCtrlKey, aAltKey, aShiftKey,
                aMetaKey, aButton, aRelatedTarget, dataTransfer);
