...
onmessage = function(event) {
  ...
  db.transaction(objectStoreName, function(trans) {
    ...
    var result = index.mozGetAllKeys(65);
    is(result instanceof Array, true, "Got an array object");
    is(result.length, 2, "Correct length");

    for (var i in result) {
      is(result[i], objectStoreDataHeightSort[parseInt(i) + 3].key,
         "Correct key");
    }

    result = index.mozGetAllKeys(65, 0);
    is(result instanceof Array, true, "Got an array object");
    is(result.length, 2, "Correct length");
    ...
    result = index.mozGetAllKeys(65, null);
    is(result instanceof Array, true, "Got an array object");
    is(result.length, 2, "Correct length");
    ...
    result = index.mozGetAllKeys(65, undefined);
    is(result instanceof Array, true, "Got an array object");
    is(result.length, 2, "Correct length");
    ...
    result = index.mozGetAllKeys();
    is(result instanceof Array, true, "Got an array object");
    is(result.length, objectStoreDataHeightSort.length,
       "Correct length");

    for (var i in result) {
      is(result[i], objectStoreDataHeightSort[i].key, "Correct key");
    }

    result = index.mozGetAllKeys(null, 4);
    is(result instanceof Array, true, "Got an array object");
    ...
    result = index.mozGetAllKeys(65, 1);
    is(result instanceof Array, true, "Got an array object");
