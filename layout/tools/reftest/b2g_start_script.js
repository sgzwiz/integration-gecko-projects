...
let serverRoot = "http://" + __marionetteParams[1] + ":" + __marionetteParams[2];
...
function setPermissions() {
  ...
  let uri = ioService.newURI(serverRoot, null, null);
...
let reftest = {};
Components.utils.import("chrome://reftest/content/reftest.jsm", reftest);
